...
// Lấy dữ liệu ban đầu của record
...
// end việc lấy dữ liệu ban đầu của record
...
while($row = mysqli_fetch_array($resultChitietdonhang, MYSQLI_ASSOC)){
    $dataSanpham[] = array(
        'sp_ten' => $row['sp_ten'],
        'sp_gia' => $row['sp_gia'],
...
//output to a client's web browser(Xlsx)
