...
if (isset($_POST['btnDatHang'])) {
    ...
    $dh_ngaydat = date('Y-m-d'); // lấy ngày hiện tại
    $dh_trangthaithanhtoan = 0; // 0: Đơn hàng chưa xử lý

    // Insert Đơn hàng
    // Câu lệnh INSERT
    $sqlDonHang = "INSERT INTO `dondathang` (dh_ngaydat, dh_ngaygiao, dh_noigiao, dh_trangthaithanhtoan, httt_ma, kh_tendangnhap) VALUES ('$dh_ngaydat', null, null, $dh_trangthaithanhtoan, $httt_ma, '$kh_tendangnhap');";
    // dd($sqlDonHang);
    ...
    // Duyệt vòng lặp sản phẩm trong giỏ hàng để thực thi câu lệnh INSERT vào table `chitietdonhang`
    foreach ($_POST['sanphamgiohang'] as $sanpham) {
        ...
        // Câu lệnh INSERT
        $sqlSanPhamDonHang = "INSERT INTO `chitietdonhang` (ctdh_ma, dh_ma, ctdh_soluong, ctdh_dongia) VALUES ($sp_ma, $last_donhang_id, $soluong, $gia);";
