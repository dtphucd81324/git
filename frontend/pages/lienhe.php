...
if(isset($_POST['btnGoiLoiNhan']))
{
    ...
    try {
        ...
        // $mail->setFrom('vyheo3107@gmail.com', 'Test Mail');
        // $mail->addAddress('thuyvyhua3107@gmail.com');                // Add a recipient
...
// Yêu cầu `Twig` vẽ giao diện được viết trong file `frontend/pages/lienhe.html.twig`
// với dữ liệu truyền vào file giao diện được đặt tên
echo $twig->render('frontend/pages/lienhe.html.twig');
